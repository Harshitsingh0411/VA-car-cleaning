    ...
    return (
      <section className="py-20 bg-white text-dark border-t border-gray-100" id="before-after">
        <div className="container mx-auto px-4 text-center">
          <div className="w-8 h-8 border-4 border-[#0D3B8E] border-t-transparent rounded-full animate-spin mx-auto" />
        </div>
      </section>
    );
  }
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="space-y-12 max-w-5xl mx-auto">
          {items.map((item, index) => (
            <ScrollReveal key={item.id} variant="fade-up" staggerIndex={index}>
